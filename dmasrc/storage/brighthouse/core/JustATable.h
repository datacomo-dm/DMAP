...
public:
	...
	virtual void LockPackForUse(unsigned attr, _int64 *pahead,unsigned pack_no, ConnectionInfo& conn) = 0;
	virtual void PreloadPack(unsigned attr, _int64 *pahead,ConnectionInfo& conn) = 0;
