...
// AttrPackN snappy compress decompress 
...
// >> Begin: Add AttrPackN_Snappy,AttrPackS_Snappy for AttrPack compress / decompress  , add by liujs
// create from copying AttrPackN,AttrPackS

#define SNAPPY_EXTERNAL_MEM_SIZE    1024*1

// AttrPackN snappy compress decompress 
class AttrPackN_Snappy : public AttrPackN
{
public:
    AttrPackN_Snappy(PackCoordinate pc, AttributeType attr_type, int inserting_mode, DataCache* owner);
    virtual ~AttrPackN_Snappy(){};
    virtual std::auto_ptr<AttrPack> Clone() const;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
// AttrPackS zip compress decompress 
class AttrPackS_Snappy : public AttrPackS
{
public:
	AttrPackS_Snappy(PackCoordinate pc, AttributeType attr_type, int inserting_mode, bool no_compression, DataCache* owner);
	virtual std::auto_ptr<AttrPack> Clone() const;
    virtual ~AttrPackS_Snappy(){};
    virtual void AllocBuffers();
...
#define LZ4_EXTERNAL_MEM_SIZE    1024*1

// AttrPackN lz4 compress decompress 
class AttrPackN_lz4 : public AttrPackN
{
public:
    AttrPackN_lz4(PackCoordinate pc, AttributeType attr_type, int inserting_mode, DataCache* owner);
    virtual ~AttrPackN_lz4(){};
    virtual std::auto_ptr<AttrPack> Clone() const;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
// AttrPackS lz4 compress decompress 
class AttrPackS_lz4 : public AttrPackS
{
public:
	AttrPackS_lz4(PackCoordinate pc, AttributeType attr_type, int inserting_mode, bool no_compression, DataCache* owner);
	virtual std::auto_ptr<AttrPack> Clone() const;
    virtual ~AttrPackS_lz4(){};
    virtual void AllocBuffers();
