...
int RCEngine::Init(const char* tab_ext, uint engine_slot)
{
    ...
    //>> begin: fix dma-1180 add by liujs
    clear_dpadmin_lst_file();
    //<< end: fix dma-1180
...
//		is_lookup = true;
	...
	}else if (int(c.find("snappycompression")) != std::string::npos){
        compress_type = Compress_Snappy;
	}else if(int(c.find("lz4compression")) != std::string::npos){
