...
int PRELOAD_OPER_LOG=(getenv("PRELOAD_OPER_LOG")!=NULL) ? atoi(getenv("PRELOAD_OPER_LOG")): 0;
int SHJOIN_MPP_N=(getenv("SIMPHASHJOIN_THREAD_NUM")!=NULL) ? atoi(getenv("SIMPHASHJOIN_THREAD_NUM")): 0;
