...
typedef enum DataCompressionType
{
   ...
   Compress_Snappy = 3,       // create AttrPack object : AttrPackS_Snappy,AttrPackN_Snappy
   Compress_Lz4 = 4,           // create AttrPack object : AttrPackS_lz4,AttrPackN_lz4
}DataCompressionType;
#define      ZIP_COMPRESSION_TYPE		0x80                   // Attr header [25],zlib compresstion		
//<< End: add by liujs

//0: no log,1: stat info,2:every pack
extern int PRELOAD_OPER_LOG;
